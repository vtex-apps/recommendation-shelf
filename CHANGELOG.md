...
- Updated EN, ES, PT translations and `defaultMessage` values in `RecommendationShelf.tsx`.
...
### Fixed
Review EN, ES and PT translations related to customizable loading placeholders and stable recommendation args. 
...
- Add support to NextInteraction campaigns.

## [2.19.1] - 2026-05-15

### Added

- Added information about how to obtain the VRN in README.md.
...
- Added support to SEARCH_BASED campaings.
